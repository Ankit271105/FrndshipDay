...
.addEventListener("mousemove", function(){
    ...
    document.querySelector("#two").style.height = "20vh"
    document.querySelector("#two").style.opacity = "1"
    document.querySelector("#two").style.filter= "blur(0.5px)"
    document.querySelector("#three").style.width = "20vw"
    document.querySelector("#three").style.height = "20vh"
    document.querySelector("#three").style.opacity = "0.9"
    document.querySelector("#three").style.filter= "blur(0.5px)"
    document.querySelector("#four").style.width = "25vw"
    document.querySelector("#four").style.height = "25vh"
...
.addEventListener("mousemove", function(){
    ...
    document.querySelector("#six").style.height = "15vh"
    document.querySelector("#six").style.opacity = "1"
    document.querySelector("#six").style.filter= "blur(0.5px)"
    document.querySelector("#seven").style.width = "15vw"
    document.querySelector("#seven").style.height = "15vh"
    document.querySelector("#seven").style.opacity = "0.9"
    document.querySelector("#seven").style.filter= "blur(0.5px)"
    document.querySelector("#eight").style.width = "20vw"
    document.querySelector("#eight").style.height = "20vh"
    document.querySelector("#eight").style.opacity = "0.8"
    document.querySelector("#eight").style.filter= "blur(0.5px)"
})
